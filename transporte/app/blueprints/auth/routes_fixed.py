...
from ...utils.data_access import get_safe_supabase_client, get_veiculos_por_empresa
        ...
        try:
            ...
            if response.data and len(response.data) > 0:
                ...
                if check_password_hash(user_data.get('senha_hash', ''), form.senha.data):
                    # Criar sessão do usuário (simulado)
...
# -----------------
# 4. ROTA DE DASHBOARD (TEMPORÁRIA - será removida)
# -----------------
